...
def run_train(
    ...
    np.save(os.path.join(run_workdir, "p_min.npy"), np.array(dataset.p_min))
    np.save(os.path.join(run_workdir, "p_max.npy"), np.array(dataset.p_max))
    np.save(os.path.join(run_workdir, "V_min.npy"), np.array(dataset.V_min))
    np.save(os.path.join(run_workdir, "V_max.npy"), np.array(dataset.V_max))

    np.save(
        os.path.join(run_workdir, "ref_energy.npy"),
        np.array(dataset.ref_energy),
    )

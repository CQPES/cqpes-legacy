...
!IF "$(CFG)" == ""
CFG=poly_cmc - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to poly_cmc - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "poly_cmc - Win32 Release" && "$(CFG)" !=\
 "poly_cmc - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "poly_cmc.mak" CFG="poly_cmc - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "poly_cmc - Win32 Release" (based on\
 "Win32 (x86) Console Application")
!MESSAGE "poly_cmc - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "poly_cmc - Win32 Debug"
F90=fl32.exe
RSC=rc.exe

!IF  "$(CFG)" == "poly_cmc - Win32 Release"
...
ALL : "$(OUTDIR)\poly_cmc.exe"

CLEAN : 
	-@erase ".\Release\poly_cmc.exe"
	-@erase ".\Release\ivtstm.obj"
	-@erase ".\Release\interface.obj"
	-@erase ".\Release\cmc.obj"
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/poly_cmc.bsc" 
BSC32_SBRS=
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib /nologo /subsystem:console /machine:I386
# ADD LINK32 kernel32.lib /nologo /subsystem:console /machine:I386
LINK32_FLAGS=kernel32.lib /nologo /subsystem:console /incremental:no\
 /pdb:"$(OUTDIR)/poly_cmc.pdb" /machine:I386 /out:"$(OUTDIR)/poly_cmc.exe" 
LINK32_OBJS= \
	"$(INTDIR)/ivtstm.obj" \
...
"$(OUTDIR)\poly_cmc.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "poly_cmc - Win32 Debug"
...
CLEAN : 
	...
	-@erase ".\Debug\poly_cmc.ilk"
	-@erase ".\Debug\poly_cmc.pdb"
...
F90_PROJ=/Ox /Zi /I "Debug/" /c /nologo /Fo"Debug/" /Fd"Debug/poly_cmc.pdb" 
F90_OBJS=.\Debug/
...
LINK32_FLAGS=kernel32.lib /nologo /subsystem:console /incremental:yes\
 /pdb:"$(OUTDIR)/poly_cmc.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/poly_cmc.exe" 
LINK32_OBJS= \
	"$(INTDIR)/ivtstm.obj" \
	"$(INTDIR)/ef.obj" \
	"$(INTDIR)/polysz.obj" \
...
# Name "poly_cmc - Win32 Release"
# Name "poly_cmc - Win32 Debug"
...
SOURCE=\MSDEV\Projects\polyrate9.3\poten\cmc.f

"$(INTDIR)\cmc.obj" : $(SOURCE) "$(INTDIR)"
   $(F90) $(F90_PROJ) $(SOURCE)

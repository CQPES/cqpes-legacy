...
!IF "$(CFG)" == ""
CFG=poly_ch4o - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to poly_ch4o - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "poly_ch4o - Win32 Release" && "$(CFG)" !=\
 "poly_ch4o - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "poly_ch4o.mak" CFG="poly_ch4o - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "poly_ch4o - Win32 Release" (based on\
 "Win32 (x86) Console Application")
!MESSAGE "poly_ch4o - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "poly_ch4o - Win32 Debug"
F90=fl32.exe
RSC=rc.exe

!IF  "$(CFG)" == "poly_ch4o - Win32 Release"
...
ALL : "$(OUTDIR)\poly_ch4o.exe"

CLEAN : 
	-@erase ".\Release\poly_ch4o.exe"
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/poly_ch4o.bsc" 
BSC32_SBRS=
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib /nologo /subsystem:console /machine:I386
# ADD LINK32 kernel32.lib /nologo /subsystem:console /machine:I386
LINK32_FLAGS=kernel32.lib /nologo /subsystem:console /incremental:no\
 /pdb:"$(OUTDIR)/poly_ch4o.pdb" /machine:I386 /out:"$(OUTDIR)/poly_ch4o.exe" 
LINK32_OBJS= \
	"$(INTDIR)/intbsv1.obj" \
	"$(INTDIR)/polymq.obj" \
	"$(INTDIR)/ef.obj" \
...
"$(OUTDIR)\poly_ch4o.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "poly_ch4o - Win32 Debug"
...
CLEAN : 
	...
	-@erase ".\Debug\poly_ch4o.ilk"
	-@erase ".\Debug\poly_ch4o.pdb"
...
F90_PROJ=/Ox /Zi /I "Debug/" /c /nologo /Fo"Debug/" /Fd"Debug/poly_ch4o.pdb" 
F90_OBJS=.\Debug/
...
LINK32_FLAGS=kernel32.lib /nologo /subsystem:console /incremental:yes\
 /pdb:"$(OUTDIR)/poly_ch4o.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/poly_ch4o.exe" 
LINK32_OBJS= \
	"$(INTDIR)/ef.obj" \
	"$(INTDIR)/givtst.obj" \
	"$(INTDIR)/acespoly.obj" \
...
# Name "poly_ch4o - Win32 Release"
# Name "poly_ch4o - Win32 Debug"
...
SOURCE=\MSDEV\Projects\polyrate9.3\poten\ch4o.f
DEP_F90_CH4O_=\
	".\..\..\poten\ch4o.inc"\
...
"$(INTDIR)\ch4o.obj" : $(SOURCE) $(DEP_F90_CH4O_) "$(INTDIR)"
   $(F90) /Ox /I "Release/" /c /nologo /Fo"Release/" $(SOURCE)
...
"$(INTDIR)\ch4o.obj" : $(SOURCE) $(DEP_F90_CH4O_) "$(INTDIR)"
   $(F90) /Zi /I "Debug/" /c /nologo /Fo"Debug/" /Fd"Debug/poly_ch4o.pdb"\
 $(SOURCE)

...
!IF "$(CFG)" == ""
CFG=poly_ohcl - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to poly_ohcl - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "poly_ohcl - Win32 Release" && "$(CFG)" !=\
 "poly_ohcl - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "poly_ohcl.mak" CFG="poly_ohcl - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "poly_ohcl - Win32 Release" (based on\
 "Win32 (x86) Console Application")
!MESSAGE "poly_ohcl - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "poly_ohcl - Win32 Debug"
F90=fl32.exe
RSC=rc.exe

!IF  "$(CFG)" == "poly_ohcl - Win32 Release"
...
ALL : "$(OUTDIR)\poly_ohcl.exe"

CLEAN : 
	-@erase ".\Release\poly_ohcl.exe"
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/poly_ohcl.bsc" 
BSC32_SBRS=
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib /nologo /subsystem:console /machine:I386
# ADD LINK32 kernel32.lib /nologo /subsystem:console /machine:I386
LINK32_FLAGS=kernel32.lib /nologo /subsystem:console /incremental:no\
 /pdb:"$(OUTDIR)/poly_ohcl.pdb" /machine:I386 /out:"$(OUTDIR)/poly_ohcl.exe" 
LINK32_OBJS= \
	"$(INTDIR)/ivtstm.obj" \
	"$(INTDIR)/chain3.obj" \
	"$(INTDIR)/polymq.obj" \
...
"$(OUTDIR)\poly_ohcl.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "poly_ohcl - Win32 Debug"
...
CLEAN : 
	...
	-@erase ".\Debug\poly_ohcl.ilk"
	-@erase ".\Debug\poly_ohcl.pdb"
...
F90_PROJ=/Ox /Zi /I "Debug/" /c /nologo /Fo"Debug/" /Fd"Debug/poly_ohcl.pdb" 
F90_OBJS=.\Debug/
...
LINK32_FLAGS=kernel32.lib /nologo /subsystem:console /incremental:yes\
 /pdb:"$(OUTDIR)/poly_ohcl.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/poly_ohcl.exe" 
LINK32_OBJS= \
	"$(INTDIR)/poly40.obj" \
	"$(INTDIR)/polysz.obj" \
	"$(INTDIR)/poly31.obj" \
...
# Name "poly_ohcl - Win32 Release"
# Name "poly_ohcl - Win32 Debug"
...
SOURCE=\MSDEV\Projects\polyrate9.3\poten\ohcl.f

"$(INTDIR)\ohcl.obj" : $(SOURCE) "$(INTDIR)"
   $(F90) $(F90_PROJ) $(SOURCE)

...
!IF "$(CFG)" == ""
CFG=poly_nh3 - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to poly_nh3 - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "poly_nh3 - Win32 Release" && "$(CFG)" !=\
 "poly_nh3 - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "poly_nh3.mak" CFG="poly_nh3 - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "poly_nh3 - Win32 Release" (based on\
 "Win32 (x86) Console Application")
!MESSAGE "poly_nh3 - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "poly_nh3 - Win32 Debug"
RSC=rc.exe
F90=fl32.exe

!IF  "$(CFG)" == "poly_nh3 - Win32 Release"
...
ALL : "$(OUTDIR)\poly_nh3.exe"

CLEAN : 
	-@erase ".\Release\poly_nh3.exe"
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/poly_nh3.bsc" 
BSC32_SBRS=
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib /nologo /subsystem:console /machine:I386
# ADD LINK32 kernel32.lib /nologo /subsystem:console /machine:I386
LINK32_FLAGS=kernel32.lib /nologo /subsystem:console /incremental:no\
 /pdb:"$(OUTDIR)/poly_nh3.pdb" /machine:I386 /out:"$(OUTDIR)/poly_nh3.exe" 
LINK32_OBJS= \
	"$(INTDIR)/intbsv3.obj" \
	"$(INTDIR)/hooks.obj" \
	"$(INTDIR)/main.obj" \
...
"$(OUTDIR)\poly_nh3.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "poly_nh3 - Win32 Debug"
...
CLEAN : 
	...
	-@erase ".\Debug\poly_nh3.ilk"
	-@erase ".\Debug\poly_nh3.pdb"
...
F90_PROJ=/Ox /Zi /I "Debug/" /c /nologo /Fo"Debug/" /Fd"Debug/poly_nh3.pdb" 
F90_OBJS=.\Debug/
...
LINK32_FLAGS=kernel32.lib /nologo /subsystem:console /incremental:yes\
 /pdb:"$(OUTDIR)/poly_nh3.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/poly_nh3.exe" 
LINK32_OBJS= \
	"$(INTDIR)/hooks.obj" \
	"$(INTDIR)/poly40.obj" \
	"$(INTDIR)/polysz.obj" \
...
# Name "poly_nh3 - Win32 Release"
# Name "poly_nh3 - Win32 Debug"
...
SOURCE=\MSDEV\Projects\polyrate9.3\poten\nh3.f

"$(INTDIR)\nh3.obj" : $(SOURCE) "$(INTDIR)"
   $(F90) $(F90_PROJ) $(SOURCE)

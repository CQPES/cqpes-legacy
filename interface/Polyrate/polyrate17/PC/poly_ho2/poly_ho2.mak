...
!IF "$(CFG)" == ""
CFG=poly_ho2 - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to poly_ho2 - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "poly_ho2 - Win32 Release" && "$(CFG)" !=\
 "poly_ho2 - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "poly_ho2.mak" CFG="poly_ho2 - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "poly_ho2 - Win32 Release" (based on\
 "Win32 (x86) Console Application")
!MESSAGE "poly_ho2 - Win32 Debug" (based on "Win32 (x86) Console Application")
!MESSAGE 
...
################################################################################
# Begin Project
# PROP Target_Last_Scanned "poly_ho2 - Win32 Debug"
F90=fl32.exe
RSC=rc.exe

!IF  "$(CFG)" == "poly_ho2 - Win32 Release"
...
ALL : "$(OUTDIR)\poly_ho2.exe"

CLEAN : 
	-@erase ".\Release\poly_ho2.exe"
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/poly_ho2.bsc" 
BSC32_SBRS=
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib /nologo /subsystem:console /machine:I386
# ADD LINK32 kernel32.lib /nologo /subsystem:console /machine:I386
LINK32_FLAGS=kernel32.lib /nologo /subsystem:console /incremental:no\
 /pdb:"$(OUTDIR)/poly_ho2.pdb" /machine:I386 /out:"$(OUTDIR)/poly_ho2.exe" 
LINK32_OBJS= \
	"$(INTDIR)/poly40.obj" \
	"$(INTDIR)/fromblas.obj" \
	"$(INTDIR)/poly31.obj" \
...
"$(OUTDIR)\poly_ho2.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "poly_ho2 - Win32 Debug"
...
CLEAN : 
	...
	-@erase ".\Debug\ho2.obj"
	-@erase ".\Debug\poly_ho2.ilk"
	-@erase ".\Debug\poly_ho2.pdb"
...
F90_PROJ=/Ox /Zi /I "Debug/" /c /nologo /Fo"Debug/" /Fd"Debug/poly_ho2.pdb" 
F90_OBJS=.\Debug/
...
LINK32_FLAGS=kernel32.lib /nologo /subsystem:console /incremental:yes\
 /pdb:"$(OUTDIR)/poly_ho2.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/poly_ho2.exe" 
LINK32_OBJS= \
	"$(INTDIR)/fromblas.obj" \
	"$(INTDIR)/headr.obj" \
	"$(INTDIR)/coord3.obj" \
...
# Name "poly_ho2 - Win32 Release"
# Name "poly_ho2 - Win32 Debug"
...
SOURCE=\MSDEV\Projects\polyrate9.3\poten\ho2.f

"$(INTDIR)\ho2.obj" : $(SOURCE) "$(INTDIR)"
   $(F90) $(F90_PROJ) $(SOURCE)
